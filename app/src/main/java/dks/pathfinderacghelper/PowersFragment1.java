 ...
 */
public class PowersFragment1 extends ListFragment {
    String charAk;
    String charAkr11;
    String charAkr12;
    String charAkr13;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        preTexts = getActivity().getResources().getStringArray(active.getCharrr1Pretxt());
        CB1Texts = getActivity().getResources().getStringArray(active.getCharrr1cb1txt());
        CB2Texts = getActivity().getResources().getStringArray(active.getCharrr1cb2txt());
        CB3Texts = getActivity().getResources().getStringArray(active.getCharrr1cb3txt());
        CB4Texts = getActivity().getResources().getStringArray(active.getCharrr1cb4txt());
        CB5Texts = getActivity().getResources().getStringArray(active.getCharrr1cb5txt());
        CB1Visible = getActivity().getResources().getStringArray(active.getCharrr1cb1Vis());
        CB2Visible = getActivity().getResources().getStringArray(active.getCharrr1cb2Vis());
        CB3Visible = getActivity().getResources().getStringArray(active.getCharrr1cb3Vis());
        CB4Visible = getActivity().getResources().getStringArray(active.getCharrr1cb4Vis());
        CB5Visible = getActivity().getResources().getStringArray(active.getCharrr1cb5Vis());
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        charAkr11 = charAk.concat("rr11");
        charAkr12 = charAk.concat("rr12");
        charAkr13 = charAk.concat("rr13");
        charAkr14 = charAk.concat("rr14");
        charAkr15 = charAk.concat("rr15");
    ...
    public class CBAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent){
            View view;
            ViewHolder holder;
            SharedPreferences sharedPrefs = getActivity().getSharedPreferences("powers1", Context.MODE_PRIVATE);
            if (convertView == null){
